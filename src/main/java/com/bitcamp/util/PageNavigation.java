...
public class PageNavigation {
  ...
  private int newArticleCount; // 오늘 쓴 글 수
  ...
  public void makeNavigator() {
    ...
    if (this.isNowFirst()) {
        ...
        tmpNavigator.append("   <lable id='firstpage'>최신목록</lable>\n");
        ...
        tmpNavigator.append("   <lable id='firstpage'>최신목록</lable>\n");
        tmpNavigator.append("   <img src='" + root + "/img/board/icon_prev01_dim.gif' width='3' height='11' border='0' align='absmiddle' hspace='3'>\n");
        tmpNavigator.append("   <lable class='mvpage' move-page-no='" + preEnd + "'>이전</lable>");
    }
    tmpNavigator.append("  \n</td>\n");
    ...
    for (int i = startPage; i <= endPage; i++) {
        if (pageNo == i) {
            ...
            tmpNavigator.append("     <td style='padding:0 7 0 7;' nowrap><lable class='mvpage' move-page-no='" + i + "'>" + i + "</lable></td>\n");
            tmpNavigator.append("     <td width='1' nowrap><img src='" + root + "/img/board/n_tab.gif' width='1'");
            tmpNavigator.append(" height='11' border='0' align='absmiddle'><br>\n");
        }
    }
    ...
    if (this.isNowEnd()) {
        ...
        tmpNavigator.append("   <lable class='mvpage' move-page-no='" + (preEnd + pageSize + 1) + "'>다음</lable><img");
        tmpNavigator.append(" src='" + root + "/img/board/icon_next01_dim.gif' width='3' height='11'");
        tmpNavigator.append(" border='0' align='absmiddle' hspace='3'>\n");
        tmpNavigator.append("   <lable class='mvpage' move-page-no='" + totalPageCount + "'>끝목록</lable><img src='" + root + "/img/board/icon_next02_dim.gif' width='7' height='11'");
        tmpNavigator.append(" border='0' align='absmiddle' hspace='3'>\n");
    }
